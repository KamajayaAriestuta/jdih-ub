    ...
    <div class="row">
      ...
      <div class="col-lg-6 col-6">
        <div class="row">
          <div class="col-md-12 col-sm-6 col-12">
            <div class="info-box">
              ...
              <div class="info-box-content">
                ...
                <span class="info-box-number">Jumlah Produk: 1</span>
                <a href="{{ route('superadmin.produk.nasional') }}" class="small-box-footer">Lihat Selengkapnya <i class="fas fa-arrow-circle-right"></i></a>
              </div>
            </div>
          </div>
          <div class="col-md-12 col-sm-6 col-12">
            <div class="info-box">
              <span class="info-box-icon bg-success"><i class="far fa fa-building"></i></span>
              <div class="info-box-content">
          ...
          <div class="col-md-12 col-sm-6 col-12">
            <div class="info-box">
              <span class="info-box-icon bg-danger"><i class="far fa fa-user"></i></span>
              <div class="info-box-content">
                <span class="info-box-text">Halaman Profil</span>
                <a href="{{ route('superadmin.produk.nasional') }}" class="small-box-footer">Lihat Selengkapnya <i class="fas fa-arrow-circle-right"></i></a>
              </div>
            </div>
          </div>
