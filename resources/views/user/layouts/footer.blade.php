<div class="container-fluid bg-dark footer mt-2 py-5 wow fadeIn" data-wow-delay="0.1s">
        <div class="container py-2">
            <div class="row g-5">
                ...
                <div class="col-lg-3 col-md-6">
                    ...
                    <a class="btn btn-link" href="{{ route('cari_produk') }}">Produk Hukum</a>
                ...
                <div class="col-lg-3 col-md-6">
                    <h5 class="text-white mb-4">Ratings</h5>
                    <p>DIH Ratings Website</p>
                    <div class="feedback">
                        <div class="rating">
