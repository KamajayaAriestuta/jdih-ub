                ...
                <div class="container">
                    <div class="row justify-content-center">
                        <div class="col-lg-10 text-start">
                            <p class="text-center">Dokumen Hukum Status: </p>
                            <h1 class="display-1 text-white text-center mb-5 animated slideInRight">{{ $judul->nama_status }}</h1>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="col-sm wow fadeIn service-item m-2" data-wow-delay="0.1s">
            <div class="p-2 d-inline">
                <div class="col-lg-10 col-md-10 px-4">
                    ...
                    <a href=""><h4 class="ml-2 d-inline"> {{ $data_jenis->perihal }}
                    </h4></a>
                </div>
