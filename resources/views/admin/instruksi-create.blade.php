...
@section ('content')
  ...
  <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
    <ol class="breadcrumb">
      ...
      <li class="breadcrumb-item active"> <a href="{{ route('admin.produk.create') }}">Tambah Instruksi</a></li>
    </ol>
  </div>
</div>
<div class="row">
  <div class="col-lg-12">
    <div class="card">
      ...
      @endif
    <div class="card-body">
    <form enctype="multipart/form-data" method="POST" action="{{ route('admin.instruksi.store') }}">
    @csrf
    <div class="row">
      ...
      <div class="col-lg-6 col-md-6 col-sm-6">
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="tanggal_ditetapkan" name="tanggal_ditetapkan" value="{{ old('tanggal_ditetapkan') }}" placeholder="Perihal Produk yang Dibahas">
        </div>
      </div>
      <div class="col-lg-6 col-md-6 col-sm-6">
        <div class="form-group">
