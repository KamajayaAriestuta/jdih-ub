...
<div class="row">
  <div class="col-lg-12">
    <div class="card">
      ...
      @endif
    <div class="card-body">
    <form enctype="multipart/form-data" method="POST" action="{{ route('admin.raper.update', $data->id) }}">
        @csrf
        @method('PUT')
    <div class="row">
      ...
      <div class="col-lg-12 col-md-12 col-sm-12 mt-2 mb-3">
        <button type="submit" class="btn btn-primary col-lg-12 col-md-12 col-sm-12 mt-2 mb-3">Edit Rancangan</button>
      </div>
    </div>
  </form>
</div>
