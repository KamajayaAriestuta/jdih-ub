                ...
                <nav class="navbar navbar-expand">
                    <div class="collapse navbar-collapse justify-content-between">
                        ...
                        <ul class="navbar-nav header-right">                         
                            ...
                            <a class="nav-link" data-toggle="dropdown" href="#"> <i class="far fa-comments"></i><span class="badge badge-danger">{{ $jumlah_user }}</span></a>
                                    ...
                                    <a href="#" class="dropdown-item">                                      
                                        ...
                                        <div class="media">
                                            <div class="media-body">
                                                <h3 class="dropdown-item-title">{{ $notifications->data['name'] }}</h3>
                                                <p class="text-sm">is Registered</p>
                                                <p class="text-sm text-muted float-right"><i class="far fa-clock mr-1"></i></p>
                                            </div>
                                        </div>
                                        <!-- Message End -->
                                        <div class="dropdown-divider"></div>
                                        @endforeach
                                        <a href="{{ route('pemohon.notify') }}" class="dropdown-item dropdown-footer">See All Messages</a>
                                    </a>
                                </div>
                            </li>
                            <li class="nav-item dropdown">
