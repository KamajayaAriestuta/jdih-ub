...
@section ('content')
  ...
  <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
    <ol class="breadcrumb">
      ...
      <li class="breadcrumb-item active"> <a href="{{ route('admin.produk.create') }}">Edit Edaran</a></li>
    </ol>
  </div>
</div>
<div class="row">
  <div class="col-lg-12">
    <div class="card">
      ...
      @endif
    <div class="card-body">
    <form enctype="multipart/form-data" method="POST" action="{{ route('admin.edaran.update', $data->id) }}">
        @csrf
        @method('PUT')
    <div class="row">
      ...
      <div class="col-lg-12 col-md-12 col-sm-12 mt-2 mb-3">
        <button type="submit" class="btn btn-primary col-lg-12 col-md-12 col-sm-12 mt-2 mb-3">Edit Edaran</button>
      </div>
    </div>
  </form>
</div>
