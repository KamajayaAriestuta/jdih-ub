<div class="dlabnav">
            <div class="dlabnav-scroll">
                <ul class="metismenu" id="menu">
					...
					<li>
						<a class="has-arrow" href="javascript:void()" -expanded="false"> <i class="la la-book text-white"></i>
						<span class="nav-text" style="color: aliceblue; font-size: 15px">Infografis</span></a>
						<ul aria-expanded="false">
							<li><a href="{{ route('admin.infografis')}}">Semua Infografis</a></li>
							<li><a href="{{ route('admin.berita.create')}}">Tambah Infografis</a></li>
						</ul>
					</li>
